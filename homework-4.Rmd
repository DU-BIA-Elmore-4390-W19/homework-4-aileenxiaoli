...
```
According to the plots shown above, we can tell that the random forest model with `mtry = 5` and `ntree = 75` generates the smallest MSE with the testing dataset.
## Problem 2
